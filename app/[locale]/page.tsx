                    ...
                    <FadeIn delay={0.6} className="mt-10 flex flex-col sm:flex-row items-start sm:items-center gap-6">
                        ...
                        <div className="flex flex-wrap items-center gap-3 sm:gap-4 pl-0 sm:pl-6 sm:border-l border-gray-200">
                            {[
                                {
                                    name: "AWS",
                                    icon: <svg className="w-5 h-5 text-[#FF9900]" viewBox="0 0 24 24" fill="currentColor"><path d="M11.05 13.91c-.24 0-.48-.04-.69-.12-.22-.08-.43-.2-.6-.35l-2.06-1.92.76-.84 2.05 1.9c.14.12.3.18.49.18.18 0 .34-.06.47-.18l4.47-4.13.78.82-4.48 4.14c-.17.15-.38.27-.6.35-.21.08-.45.12-.69.12z" /><path d="M11.95 21.8c-1.8 0-3.5-.4-5.1-1.2-1.6-.8-3-1.9-4.1-3.2l.8-.7c1.1 1.2 2.3 2.1 3.7 2.8 1.4.7 3 .1 4.6.1 2.2 0 4.2-.6 6-1.7l.6.8c-2 1.2-4.2 1.8-6.5 1.8z" /></svg>,
                                    bg: "hover:border-[#FF9900]/30"
                                },
                                {
                                    name: "Azure",
                                    icon: <svg className="w-4 h-4 text-[#0089D6]" viewBox="0 0 24 24" fill="currentColor"><path d="M5.4 21.2H0L6.4 2.8h4.5zM24 21.2h-5.2l-4.5-12.7L24 21.2zm-12 0l-4.5-12.7L12 2.8h5.2z" /></svg>,
                                    bg: "hover:border-[#0089D6]/30"
                                },
                                {
                                    name: "Terraform",
                                    icon: <svg className="w-4 h-4 text-[#844FBA]" viewBox="0 0 24 24" fill="currentColor"><path d="M1.6 3.9v7.7l6.5 3.8V7.7L1.6 3.9z" /><path d="M9.4 7.7v7.7l6.5 3.8V11.5L9.4 7.7z" /><path d="M17.2 3.9v7.7l6.5 3.8V7.7l-6.5-3.8z" opacity="0.6" /><path d="M9.4 19.3v7.7l6.5-3.8v-7.7l-6.5 3.8z" /></svg>,
