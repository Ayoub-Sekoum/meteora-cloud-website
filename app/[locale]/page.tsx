                    ...
                    <FadeIn delay={0.6} className="mt-10 flex flex-col sm:flex-row items-start sm:items-center gap-6">
                        ...
                        <div className="flex flex-wrap items-center gap-3 sm:gap-4 pl-0 sm:pl-6 sm:border-l border-gray-200">
                            {[
                                {
                                    name: "AWS",
                                    icon: <svg className="w-5 h-5 text-[#FF9900]" viewBox="0 0 256 153" fill="currentColor"><path d="M72.392 55.438c0 3.84.414 6.95 1.15 9.328.828 2.378 1.84 4.94 3.222 7.686.506.828.736 1.656.736 2.392 0 1.012-.644 2.024-2.024 3.036l-6.674 4.438c-.966.644-1.932 1.012-2.806 1.012-1.104 0-2.208-.644-3.312-1.84-1.472-1.656-2.76-3.404-3.818-5.152-1.058-1.84-2.116-3.864-3.266-6.212-8.234 9.696-18.574 14.544-31.02 14.544-8.878 0-15.92-2.532-21.034-7.596-5.114-5.064-7.686-11.828-7.686-20.336 0-9.006 3.128-16.324 9.512-21.848 6.384-5.524 14.888-8.282 25.694-8.282 3.588 0 7.268.322 11.132.874 3.864.552 7.87 1.38 12.106 2.392V24.718c0-8.05-1.656-13.672-4.876-16.97-3.312-3.298-8.924-4.876-16.97-4.876-3.68 0-7.452.46-11.316 1.38-3.864 .92-7.636 2.024-11.316 3.404-1.012.46-1.84.736-2.484.92-.644.184-1.104.276-1.472.276-1.288 0-1.932-.92-1.932-2.852V2.95c0-1.472.184-2.576.644-3.22.46-.736 1.288-1.472 2.576-2.208 3.68-1.84 8.096-3.404 13.256-4.692C43.308.598 48.928 0 54.824 0c12.382 0 21.434 2.806 27.312 8.418 5.786 5.612 8.694 14.13 8.694 25.556v33.464H72.392zM246.392 78.472c-4.232 0-7.544-1.288-10.68-3.772-3.128-2.576-5.244-6.212-6.396-10.81-1.196-4.876-1.748-10.626-1.748-17.338V0h13.256v46.46c0 9.236 1.012 15.828 3.036 19.776 2.116 3.948 5.704 5.888 10.994 5.888 3.864 0 7.544-1.104 10.994-3.312 3.496-2.208 6.028-5.244 7.636-9.006V0h13.256v59.642c0 4.14.46 6.95 1.288 8.464.92 1.472 2.576 2.668 5.06 3.588l-3.68 9.328c-5.152-1.472-9.052-3.588-11.684-6.396-5.52 4.6-12.198 6.95-20.06 6.95l-11.272-3.104zM203.31 127.892c-26.864 19.888-65.812 30.446-99.276 30.446-46.97 0-89.332-17.338-121.314-46.184-2.484-2.3-.276-5.428 2.76-3.588 34.566 20.06 77.296 32.212 121.406 32.212 29.802 0 62.534-6.212 92.704-18.942 4.508-2.024 8.326 2.944 3.72 6.056zM213.896 115.786c-3.404-4.416-22.526-2.116-31.128-1.058-2.576.322-2.99-1.932-.644-3.68 15.276-10.742 40.326-7.636 43.262-4.048 2.944 3.68-.828 28.888-15.092 40.97-2.208 1.84-4.278.874-3.312-1.564 3.22-8.05 10.35-26.312 6.914-30.62z" /></svg>,
                                    bg: "hover:border-[#FF9900]/30"
                                },
                                {
                                    name: "Azure",
                                    icon: <svg className="w-5 h-5 text-[#0089D6]" viewBox="0 0 96 96" fill="currentColor"><path d="M33.338 6.544h26.038l-27.03 80.455a4.152 4.152 0 01-3.933 2.833H8.149a4.145 4.145 0 01-3.928-5.47L29.404 9.378a4.152 4.152 0 013.934-2.834zM33.338 6.544a4.118 4.118 0 00-3.943 2.879L4.252 83.506a4.144 4.144 0 003.908 5.538h20.787a4.443 4.443 0 003.41-2.9l5.014-14.777 17.91 16.705a4.237 4.237 0 002.666.972h21.894L62.87 60.261l-30.355.002L53.917 6.544H33.338z" /><path d="M71.175 60.261H41.29a1.911 1.911 0 00-1.305 3.309l26.532 24.764a4.171 4.171 0 002.846 1.121h22.094L71.175 60.261z" opacity="0.6" /></svg>,
                                    bg: "hover:border-[#0089D6]/30"
                                },
                                {
                                    name: "Terraform",
                                    icon: <svg className="w-5 h-5 text-[#844FBA]" viewBox="0 0 256 289" fill="currentColor"><path d="M88.344 50.418v87.672l75.928 43.836V94.254L88.344 50.418z" /><path d="M176.272 94.254v87.672l75.928-43.836V50.418l-75.928 43.836z" opacity="0.6" /><path d="M0 6.582v87.672l75.928 43.836V50.418L0 6.582z" /><path d="M88.344 238.418v-87.672l75.928 43.836v87.672l-75.928-43.836z" /></svg>,
